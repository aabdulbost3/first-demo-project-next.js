            ...
            <div className={styles.headerinfoleft}>
              <div className={styles.headerinfolefttext}>
                ...
                <div className={styles.headerinfotextp}>
                  <p>Create custom landing pages with Omega that convert more visitors than any website. With lots of unique blocks, you can easily build a page without coding.
                  </p>
                </div>
                ...
                <div className={styles.headerinfoicon}>
                  ...
                  <span>Watch the intro video</span></p>
